...
void S_Renderer::SortDrawables() {
	...
	std::sort(m_Entities.begin(), m_Entities.end(),
		[e_mgr](unsigned int l_One, unsigned int l_Two)
		{
			auto pos1 = e_mgr->GetComponent<C_Position>(l_One, Component::Position);
			auto pos2 = e_mgr->GetComponent<C_Position>(l_Two, Component::Position);
